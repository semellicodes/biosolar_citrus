                ...
                child: Row(
                  children: [
                    Segmentado(
                      ...
                      aoSelecionar: (indice) => bloc.add(
                        FiltroAlterado(switch (indice) {
                          1 => Origem.sistema,
                          2 => Origem.operador,
                          _ => null,
                        }),
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: doSistema ? aparencia.cor : Colors.transparent,
              border: Border.all(
                color: doSistema ? aparencia.cor : Cores.borda,
              ),
